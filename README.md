...
# Step 2: Run xss_checker.py with the cleaned URLs
python3 xss_checker.py -l final.txt -p $PAYLOAD_FILE -t $THREADS
...
# Step 4: Run xss_checker.py again with the filtered URLs
python3 xss_checker.py -l final.txt -p $PAYLOAD_FILE -t $THREADS
